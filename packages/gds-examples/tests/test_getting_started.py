...
class TestStage1Minimal:
    def test_spec_builds(self):
        from gds_examples.getting_started.stage1_minimal import build_spec
    ...
    def test_system_compiles(self):
        from gds_examples.getting_started.stage1_minimal import build_system
    ...
    def test_mechanism_updates_room(self):
        from gds_examples.getting_started.stage1_minimal import update_temperature

        assert update_temperature.updates == [("Room", "temperature")]

    def test_heater_has_no_forward_in(self):
        from gds_examples.getting_started.stage1_minimal import heater
...
class TestStage2Feedback:
    def test_spec_builds(self):
        from gds_examples.getting_started.stage2_feedback import build_spec
    ...
    def test_system_compiles(self):
        from gds_examples.getting_started.stage2_feedback import build_system
...
class TestStage3DSL:
    def test_model_builds(self):
        from gds_examples.getting_started.stage3_dsl import build_model
    ...
    def test_system_compiles(self):
        from gds_examples.getting_started.stage3_dsl import build_system
    ...
    def test_canonical_projection(self):
        from gds_examples.getting_started.stage3_dsl import build_canonical
...
class TestStage4VerifyViz:
    def test_generic_checks_pass(self):
        from gds_examples.getting_started.stage3_dsl import build_system
        from gds_examples.getting_started.stage4_verify_viz import run_generic_checks
    ...
    def test_semantic_checks_produce_output(self):
        from gds_examples.getting_started.stage3_dsl import build_spec
        from gds_examples.getting_started.stage4_verify_viz import run_semantic_checks
...
class TestStage5Query:
    def test_query_builds(self):
        from gds_examples.getting_started.stage5_query import build_query
...
_NOTEBOOK = Path(__file__).resolve().parent.parent / "notebooks" / "getting_started.py"
