...
class TestImports:
    def test_import_all(self):
        from gds_domains import business

        assert hasattr(business, "CausalLoopModel")
        assert hasattr(business, "SupplyChainModel")
        assert hasattr(business, "ValueStreamModel")
        assert hasattr(business, "verify")
        assert hasattr(business, "BusinessDiagramKind")

    def test_all_exports_accessible(self):
        from gds_domains import business

        for name in business.__all__:
            assert hasattr(business, name), f"Missing export: {name}"
