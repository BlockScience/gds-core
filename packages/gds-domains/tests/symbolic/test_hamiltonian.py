...
from gds_domains.symbolic.hamiltonian import (  # noqa: E402
    HamiltonianSpec,
    HamiltonianSystem,
    derive_hamiltonian,
    verify_conservation,
...
class TestDeriveFromModel:
    ...
    def test_from_symbolic_model(self) -> None:
        from gds_domains.control.dsl.elements import Input, State
        from gds_domains.symbolic import SymbolicControlModel
        from gds_domains.symbolic.elements import StateEquation
        from gds_domains.symbolic.hamiltonian import derive_from_model
