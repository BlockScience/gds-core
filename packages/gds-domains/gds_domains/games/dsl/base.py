...
if TYPE_CHECKING:
    ...
    from gds_domains.games.dsl.games import AtomicGame
...
class OpenGame(Block):
    ...
    def __or__(self, other: OpenGame) -> ParallelComposition:  # type: ignore[override]
        ...
        from gds_domains.games.dsl.composition import ParallelComposition
    ...
    def feedback(self, wiring: list[Flow]) -> FeedbackLoop:  # type: ignore[override]
        ...
        from gds_domains.games.dsl.composition import FeedbackLoop
    ...
    def corecursive(
        ...
        from gds_domains.games.dsl.composition import CorecursiveLoop
