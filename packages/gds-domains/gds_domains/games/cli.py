...
def compile_dsl(
    ...
    from gds_domains.games.ir.serialization import IRDocument, IRMetadata, save_ir
...
def verify_cmd(
    ...
    from gds_domains.games.ir.serialization import load_ir
    from gds_domains.games.verification.engine import verify
    from gds_domains.games.verification.findings import Severity
