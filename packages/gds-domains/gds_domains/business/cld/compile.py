...
from gds_domains.business.cld.elements import Variable
from gds_domains.business.common.compile_utils import parallel_tier
...
def compile_cld(model: CausalLoopModel) -> GDSSpec:
    ...
    # CLDs model causal feedback — discrete/synchronous/Moore
