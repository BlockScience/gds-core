...
from gds_domains.business.common.errors import BizValidationError
...
class SupplyChainModel(BaseModel):
    ...
    def compile(self) -> GDSSpec:
        ...
        from gds_domains.business.supplychain.compile import compile_scn
    ...
    def compile_system(self) -> SystemIR:
        ...
        from gds_domains.business.supplychain.compile import compile_scn_to_system
