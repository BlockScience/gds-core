...
def verify(
    ...
    """
    from gds_domains.business.cld.checks import ALL_CLD_CHECKS
    from gds_domains.business.cld.model import CausalLoopModel
    from gds_domains.business.supplychain.checks import ALL_SCN_CHECKS
    from gds_domains.business.supplychain.model import SupplyChainModel
    from gds_domains.business.vsm.checks import ALL_VSM_CHECKS
