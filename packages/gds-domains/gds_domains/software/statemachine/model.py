...
from gds_domains.software.common.errors import SWValidationError
from gds_domains.software.statemachine.elements import Event, Region, State, Transition
...
class StateMachineModel(BaseModel):
    ...
    def compile(self) -> GDSSpec:
        ...
        from gds_domains.software.statemachine.compile import compile_sm
    ...
    def compile_system(self) -> SystemIR:
        ...
        from gds_domains.software.statemachine.compile import compile_sm_to_system
