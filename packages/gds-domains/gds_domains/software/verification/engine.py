...
def verify(
    ...
    """
    from gds_domains.software.c4.checks import ALL_C4_CHECKS
    from gds_domains.software.c4.model import C4Model
    from gds_domains.software.component.checks import ALL_CP_CHECKS
    from gds_domains.software.component.model import ComponentModel
    from gds_domains.software.dependency.checks import ALL_DG_CHECKS
    from gds_domains.software.dependency.model import DependencyModel
    from gds_domains.software.dfd.checks import ALL_DFD_CHECKS
    from gds_domains.software.dfd.model import DFDModel
    from gds_domains.software.erd.checks import ALL_ER_CHECKS
    from gds_domains.software.erd.model import ERDModel
    from gds_domains.software.statemachine.checks import ALL_SM_CHECKS
