...
from gds_domains.software.erd.elements import ERDEntity, ERDRelationship
...
class ERDModel(BaseModel):
    ...
    def compile(self) -> GDSSpec:
        from gds_domains.software.erd.compile import compile_erd

        return compile_erd(self)

    def compile_system(self) -> SystemIR:
        from gds_domains.software.erd.compile import compile_erd_to_system
