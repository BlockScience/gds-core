...
from gds_domains.symbolic.elements import OutputEquation, StateEquation  # noqa: TC001
...
class SymbolicControlModel(ControlModel):
    ...
    def to_ode_function(
        ...
        """
        from gds_domains.symbolic.compile import compile_to_ode
    ...
    def linearize(
        ...
        """
        from gds_domains.symbolic.linearize import linearize
