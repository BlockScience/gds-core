...
from gds_interchange.owl.serialize import to_turtle


class TestSpecRoundTrip:
    def _round_trip(self, spec: GDSSpec) -> GDSSpec:
        from gds_interchange.owl.export import spec_to_graph
...
class TestSystemIRRoundTrip:
    def _round_trip(self, ir: SystemIR) -> SystemIR:
        from gds_interchange.owl.export import system_ir_to_graph
...
class TestCanonicalRoundTrip:
    def _round_trip(self, can: CanonicalGDS) -> CanonicalGDS:
        from gds_interchange.owl.export import canonical_to_graph
...
class TestReportRoundTrip:
    def _round_trip(self, report: VerificationReport) -> VerificationReport:
        from gds_interchange.owl.export import report_to_graph
